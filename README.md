...
<table>
  <tr>
    <td valign="top" width="50%">
      <h3>🚀 olivier_mono_repo</h3>
      <p>
        A monorepository focused on Angular frontend architecture using Domain-Driven Design,
        with a fake runtime backend powered by REST JSON and GraphQL JSON.
      </p>
    </td>
    <td valign="top" width="50%">
      <h3>🐍 python</h3>
...
<ul>
  <li>💼 <strong>LinkedIn:</strong> <a href="https://www.linkedin.com/in/olivier-lowe-04b026284/">olivier</a></li>
